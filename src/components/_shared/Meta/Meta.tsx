...
export const Meta: FunctionComponent<IMetaProps> = ({
  ...
  const siteAuthor = sanitizeEncodedChar(
    ConfigProvider.getValue('SITE_AUTHOR')
  );
  ...
  const metaTags: Array<Partial<Core.IMetaTag>> = [...defaultMetaTags, ...meta];
