...
import { CLEAR_CATEGORY, GET_CATEGORY_FAILED, GET_CATEGORY_SUCCESS } from './constants';

export const getCategory: ActionCreator<ThunkAction<Promise<any>, IReduxState, IReduxDispatch, AnyAction>> = () => {
