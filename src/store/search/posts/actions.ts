...
export const getPostsSearch: ActionCreator<ThunkAction<Promise<any>, IReduxState, IReduxDispatch, AnyAction>> = (
  searchTerm: string
) => {
...
export const getSearchPostsFailed = (error: Core.IErrorResponse | AxiosError) => ({
